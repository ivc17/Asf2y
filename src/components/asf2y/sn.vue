...
export default {
  ...
  methods: {
    render: function() {
      ...
      // this.renderer.setRenderTarget(renderBack1)
      this.renderer.render(sceneBack, cameraBack)
    ...
    debounce: function(callback, duration, event) {
      var timer
      clearTimeout(timer)
