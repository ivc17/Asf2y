<template>
  <div class="s9" ref="s9">
    <img class="sunny" src="@/assets/sunny.jpg" />
    <img class="balloons" src="@/assets/balloons.jpg" />
    <img class="marbleAd" src="@/assets/marbleAd.jpg" />
    <canvas ref="s9Canvas" class="s9Canvas"></canvas>
    <div class="leftCol">
      <div>
        <img class="nanYang" src="@/assets/nanYang.jpg" />
        <img class="view" src="@/assets/view.jpg" />
        <img class="underSun" src="@/assets/underSun.jpg" />
      </div>
      <div>
        <img class="nanYang" src="@/assets/nanYang.jpg" />
        <img class="view" src="@/assets/view.jpg" />
