...
GlitchPass.prototype = Object.assign(Object.create(Pass.prototype), {
  ...
  render: function(
    ...
    if (this.curF % this.randX == 0 || this.goWild == true) {
      ...
      this.uniforms['seed_x'].value = MathUtils.randFloat(-1, 0.1)
      this.uniforms['seed_y'].value = MathUtils.randFloat(-1, 0.1)
      ...
      this.uniforms['seed_x'].value = MathUtils.randFloat(-0.3, 0.05)
      this.uniforms['seed_y'].value = MathUtils.randFloat(-0.3, 0.05)
  ...
  generateHeightmap: function(dt_size) {
    ...
    for (var i = 0; i < length; i++) {
      var val = MathUtils.randFloat(0, 0.4)
      data_arr[i * 3 + 0] = val
      data_arr[i * 3 + 1] = val
      data_arr[i * 3 + 2] = val
    }
